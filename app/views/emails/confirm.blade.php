          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="text-align: center; padding: 15px; background-color: #010101">
                <a href="#"><img class="w320" width="320" height="69" src="{{url('/')}}/img/logo-default-gold.png" alt="McRiver" /></a>
              </td>
            </tr>
          </table>
                ...
                <table class="table table-striped" style="width: 80%; max-width: 300px">
					...
					<tfoot>
						<tr class="success">
							...
							<th style="text-align:left; padding: 5px;">${{number_format($person->total)}}</th>
						</tr>
					</tfoot>
				</table>
