...
<head>
  ...
  <title>McRiver {{$order->year}} Order Status</title>
          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="text-align: center; padding: 15px; background-color: #010101">
                <a href="{{url('/')}}"><img class="w320" width="320" height="69" src="http://www.mcriver.net/assets/img/logo-default-gold.png" alt="McRiver" /></a>
              </td>
            </tr>
          </table>
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width" style="width: 100%">
                  <tr>
                    ...
                    <!--<div class="mobile-br">&nbsp;</div>-->
                      McRiver {{$order->year}} Order Status
                    <br/>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size:20px; text-align:center; padding: 0 75px; color: #ffffff; padding: 0 0 10px 0; width: 100%" class="w320 mobile-spacing">
                        Details below
                    </td>
                  </tr>
                </table>
              ...
              <center>
                <table style="margin:0 auto; width: 80%;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    ...
                    <br>
                    <strong>Name:</strong> {{$names[0]}}<br>
                    <strong>Order Number:</strong> <a href="https://mcriver.net/order-lookup?email={{$order->email}}&order={{$order->friendly_order_id}}">{{$order->friendly_order_id}}</a><br>
                    <strong>Payment Method:</strong> {{ucwords($order->payment_method)}}<br><br>
                    @if(!$order->is_paid)
                    <strong>Your payment has not been recieved, please send a check or money order to:<br>
                    <address>
                        Jim McDonald<br>
                ...
                <table class="table table-striped" style="width: 80%; max-width: 300px">
                    ...
                    @for($i = 0; $i < count($names); $i++)
                        <tr class="person-{{$i}}-row" data-person="{{$i}}">
                            <td style="border-bottom:1px solid #e3e3e3; padding: 5px;">{{$names[$i]}}</td>
